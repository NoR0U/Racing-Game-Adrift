...
public class engineAudio_2 : MonoBehaviour
{
    ...
    public CarController4 m_CarController;
    ...
    private void Start()
    {
        ...
        m_CarController = transform.root.gameObject.GetComponent<CarController4>();
        IN = transform.root.gameObject.GetComponent<inputs_2>();
